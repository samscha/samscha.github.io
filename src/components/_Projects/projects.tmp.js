...
const Jobseekr_forked = {
  urls: [
    ...
    {
      text: 'Blog',
      link: 'https://medium.com/@samscha/adding-search-and-duplicate-checker-to-an-existing-job-seeker-app-detailed-8577a0339429',
    },
  ],
  technologies: [
    { technology: 'MongoDB' },
...
const CashEnvelope = {
  urls: [
    ...
    {
      text: 'Blog',
      link: 'https://medium.com/@samscha/creating-a-postgres-java-spring-react-native-virtual-cash-envelope-app-in-depth-tutorial-9dc62af8fd3f',
    },
  ],
  technologies: [
